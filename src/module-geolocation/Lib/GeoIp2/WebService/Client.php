...
namespace Eloom\Geolocation\Lib\GeoIp2\WebService;

use Eloom\Geolocation\Lib\GeoIp2\Exception\AddressNotFoundException;
use Eloom\Geolocation\Lib\GeoIp2\Exception\AuthenticationException;
use Eloom\Geolocation\Lib\GeoIp2\Exception\GeoIp2Exception;
use Eloom\Geolocation\Lib\GeoIp2\Exception\HttpException;
use Eloom\Geolocation\Lib\GeoIp2\Exception\InvalidRequestException;
use Eloom\Geolocation\Lib\GeoIp2\Exception\OutOfQueriesException;
use Eloom\Geolocation\Lib\GeoIp2\ProviderInterface;
use Eloom\Geolocation\Lib\MaxMind\WebService\Client as WsClient;
...
class Client implements ProviderInterface {
	...
	private function responseFor($endpoint, $class, $ipAddress) {
		...
		$class = 'Eloom\Geolocation\Lib\GeoIp2\Model\\' . $class;
